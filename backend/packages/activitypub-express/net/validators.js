...
const needsResolveObject = ['block', 'create', 'follow', 'like']
const needsResolveActivity = ['accept', 'add', 'announce', 'reject', 'remove']
...
const requiresObject = ['create', 'delete', 'follow', 'update', 'like']
const requiresActivityObject = ['add', 'accept', 'announce', 'reject', 'remove']
const obxRequiresActivityObject = ['add', 'accept', 'announce', 'reject', 'remove', 'undo']
